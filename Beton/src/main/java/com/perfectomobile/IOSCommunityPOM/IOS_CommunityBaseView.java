...
//	
//	// Class constructor
//	public void CommunityBaseView(AndroidDriver driver){
//		this.driver = driver;
//					
//	}
//	// init to check for BasePage load and log-in if necessary	
//	public CommunityBaseView login(String appUser, String appUserPwd){		
...
//		
//	//Open menu drawer	
//	public MenuPageView openMenuDrawer(){
//		this.driver.findElement(actionBarTitle).click();
//		return new MenuPageView(this.driver);
//	}
//	
//	// click top menu search button 
//	public MenuPageView clickSearchButton(){
//		this.driver.findElement(btnSearch).click();
//		return new MenuPageView(this.driver);
//	}
//	
//	// close the search field 
//	public MenuPageView closeSearch(){
...
//	public SearchResultsView inputSearchText(String q){
